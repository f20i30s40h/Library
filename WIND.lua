...
function a.b()
  ...
  function m.SafeCallback(p, ...)
    ...
    if not r then
      if l and l.Window and l.Window.Debug then
        ...
        return l:Notify({ Title = "DEBUG Mode: Error", Content = not x and u or u:sub(x + 1), Duration = 8 })
      end
    end
  end
  ...
  function m.ChangeTranslationKey(p, r, u)
    if m.Localization and m.Localization.Enabled then
      ...
      if v then
        ...
        table.insert(m.LocalizationObjects, { TranslationId = v, Object = r })
  ...
  function m.NewRoundFrame(p, r, u, v, A, B)
    ...
    local C = m.New(
    A and "ImageButton" or "ImageLabel",
    {
  ...
  function m.Drag(u, v, A)
    ...
    local function update(J)
      ...
      m.Tween(u, 0.02, { Position = UDim2.new(G.X.Scale, G.X.Offset + L.X, G.Y.Scale, G.Y.Offset + L.Y) })
      :Play()
    end
  ...
  function m.Image(u, v, A, B, C, F, G, H)
    ...
    { Size = UDim2.new(0, 0, 0, 0), BackgroundTransparency = 1 },
    {
      ...
      "ImageLabel",
      {
        ...
        BackgroundTransparency = 1,
        ScaleType = "Crop",
        ThemeTag = (m.Icon(u) or G) and { ImageColor3 = F and (H or "Icon") or nil } or nil,
      },
      { p("UICorner", { CornerRadius = UDim.new(0, A) }) }
      ),
    }
    )
    if m.Icon(u) then
      J.ImageLabel:Destroy()
      local L = j.Image({ Icon = u, Size = UDim2.new(1, 0, 1, 0), Colors = {
     ...
     elseif string.find(u, "http") then
      ...
      local M, N = pcall(function()
        task.spawn(function()
          local M = m.Request({ Url = u, Method = "GET" }).Body
          writefile(L, M)
      ...
      if not M then
        warn(
        "[ WindUI.Creator ]  '" .. identifyexecutor() .. "' doesnt support the URL Images. Error: " .. N
        )
        J:Destroy()
      end
     elseif u == "" then
...
function a.d()
  ...
  function g.New(h)
    ...
    local m = e(
    "Frame",
    { Size = UDim2.new(0, 0, 1, 0), BackgroundTransparency = 0.95, ThemeTag = { BackgroundColor3 = "Text" } }
    )
    local p = e(
    "Frame",
    {
    ...
    },
    {
      ...
      { m, e("UICorner", { CornerRadius = UDim.new(0, g.UICorner) }) }
      ),
      e(
      "ImageLabel",
      {
    ...
    local u = e("Frame", { BackgroundTransparency = 1, Size = UDim2.new(1, 0, 0, 0), Parent = h.Holder }, { r })
    function i.Close(v)
...
function a.e()
  ...
  function ab.New(ac, ad)
    ...
    local ay = function(ay)
      ...
      local aC =
      ak({ Url = aA, Method = "POST", Body = X(aB), Headers = { ["Content-Type"] = "application/json" } })
...
function a.h()
  return {
    ...
    pandadevelopment = { Name = "Panda Development", Icon = "panda", Args = { "ServiceId" }, New = a.load("f").New },
    luarmor = {
      Name = "Luarmor",
...
function a.j()
  ...
  function aa.New(ae, af, ag, ah, ai, aj, ak, al)
    ...
    local ao = ac(
    "TextButton",
    { Size = UDim2.new(0, 0, 1, 0), AutomaticSize = "X", Parent = ai, BackgroundTransparency = 1 },
    {
      ab.NewRoundFrame(
      am,
      "Squircle",
...
function a.k()
  ...
  function aa.New(ae, af, ag, ah, ai, aj, ak, al)
    ...
    local aq = ac(
    "Frame",
    { Size = UDim2.new(1, 0, 0, 42), Parent = ag, BackgroundTransparency = 1 },
    {
      ac(
      "Frame",
      { Size = UDim2.new(1, 0, 1, 0), BackgroundTransparency = 1 },
      {
        ...
        am,
        "Squircle",
        { ThemeTag = { ImageColor3 = "Accent" }, Size = UDim2.new(1, 0, 1, 0), ImageTransparency = 0.97 }
        ),
        ab.NewRoundFrame(
        am,
        "SquircleOutline",
        { ThemeTag = { ImageColor3 = "Outline" }, Size = UDim2.new(1, 0, 1, 0), ImageTransparency = 0.95 },
        {}
        ),
        ab.NewRoundFrame(
        am,
...
function a.l()
  ...
  function ad.Create(ae, af)
    ...
    ag.UIElements.Main = ab(
    "Frame",
    {
      Size = UDim2.new(0, 280, 0, 0),
      ThemeTag = { BackgroundColor3 = af .. "Background" },
      AutomaticSize = "Y",
      BackgroundTransparency = 1,
      Visible = false,
      ZIndex = 99999,
    ...
    ag.UIElements.MainContainer = aa.NewRoundFrame(
    ag.UICorner,
    "Squircle",
    {
      Visible = false,
      ...
      AnchorPoint = Vector2.new(0.5, 0.5),
      AutomaticSize = "XY",
      ThemeTag = { ImageColor3 = af .. "Background", ImageTransparency = af .. "BackgroundTransparency" },
      ZIndex = 9999,
    },
    { ag.UIElements.Main }
    )
    function ag.Open(ah)
      ...
      task.spawn(function()
        ...
        if not ae then
          ac(ag.UIElements.FullScreen, 0.1, { BackgroundTransparency = 0.3 }):Play()
        end
...
function a.m()
  ...
  function aa.new(ag, ah, ai)
    ...
    local as = ac(
    "Frame",
    { BackgroundTransparency = 1, AutomaticSize = "XY" },
    {
      ac(
      "UIListLayout",
      { Padding = UDim.new(0, 14), FillDirection = "Horizontal", VerticalAlignment = "Center" }
      ),
      ap,
      aq,
    }
    ...
    local at = ac(
    "Frame",
    { AutomaticSize = "Y", Size = UDim2.new(1, 0, 0, 0), BackgroundTransparency = 1 },
    { as, ar }
    )
    ...
    { Size = UDim2.new(1, 0, 0, 42), BackgroundTransparency = 1 },
    {
      ac(
      "Frame",
      { BackgroundTransparency = 1, AutomaticSize = "X", Size = UDim2.new(0, 0, 1, 0) },
      { ac("UIListLayout", { Padding = UDim.new(0, 9), FillDirection = "Horizontal" }) }
      ),
    }
    )
    local ax
    if ag.KeySystem.Thumbnail and ag.KeySystem.Thumbnail.Image then
      ...
      { ay, ac("UICorner", { CornerRadius = UDim.new(0, 20) }) }
      )
    end
    ac(
    "Frame",
    ...
    },
    {
      ...
      { Size = UDim2.new(1, 0, 1, 0), BackgroundTransparency = 1 },
      {
        ac("UIListLayout", { Padding = UDim.new(0, 18), FillDirection = "Vertical" }),
        at,
        av,
        au,
        aw,
    ...
    if ag.KeySystem.API then
      ...
      local aC = ab.NewRoundFrame(
      99,
      "Squircle",
      { Size = UDim2.new(0, 1, 1, 0), ThemeTag = { ImageColor3 = "Text" }, ImageTransparency = 0.9 }
      )
      ac(
      "Frame",
      { BackgroundTransparency = 1, Size = UDim2.new(0, 0, 1, 0), AutomaticSize = "X", Parent = aB.Frame },
      { aC, ac("UIPadding", { PaddingLeft = UDim.new(0, 5), PaddingRight = UDim.new(0, 5) }) }
      )
      local aD = ab.Image("chevron-down", "chevron-down", 0, "Temp", "KeySystem", true)
      aD.Size = UDim2.new(1, 0, 1, 0)
      ac("Frame", { Size = UDim2.new(0, 21, 0, 21), Parent = aB.Frame, BackgroundTransparency = 1 }, { aD })
      local aE = ab.NewRoundFrame(
      15,
      "Squircle",
      { Size = UDim2.new(1, 0, 0, 0), AutomaticSize = "Y", ThemeTag = { ImageColor3 = "Background" } },
      {
        ac(
        "UIPadding",
        {
      ...
      for e, g in next, ag.KeySystem.API do
        ...
        if h then
          ...
          },
          {
            ac(
            "UIListLayout",
            { FillDirection = "Horizontal", Padding = UDim.new(0, 10), VerticalAlignment = "Center" }
            ),
            p,
            ac(
            "UIPadding",
            ...
            ac(
            "Frame",
            { BackgroundTransparency = 1, Size = UDim2.new(1, -34, 0, 0), AutomaticSize = "Y" },
            {
              ac(
              "UIListLayout",
              {
    ...
    local az = ae("Submit", "arrow-right", function()
      ...
      if not ag.KeySystem.API then
        ...
        if aB then
          ...
          ag.WindUI:Notify({ Title = "Key System. Error", Content = aC, Icon = "triangle-alert" })
        end
      end
    end, "Primary", aw)
...
function a.o()
  ...
  local function createAcrylic()
    ...
    { ab("SpecialMesh", { MeshType = Enum.MeshType.Brick, Offset = Vector3.new(0, 0, -1E-6) }) }
    )
    return af
  end
  local function createAcrylicBlur(af)
    local ag = {}
    af = af or 0.001
    local ah = { topLeft = Vector2.new(), topRight = Vector2.new(), bottomRight = Vector2.new() }
  ...
  return function(af)
    ...
    local aj = ab("Frame", { BackgroundTransparency = 1, Size = UDim2.fromScale(1, 1) })
...
function a.p()
  ...
  return function(ad)
    ...
    },
    {
      ...
      ac("Frame", { BackgroundTransparency = 1, Size = UDim2.fromScale(1, 1), ZIndex = 2 }, {}),
    }
    )
    local af
    task.wait()
...
function a.r()
  ...
  function aa.new(ae)
    ...
    { ac(
      "UIListLayout",
      { Padding = UDim.new(0, 9), FillDirection = "Horizontal", HorizontalAlignment = "Right" }
      ) }
    )
    local aq
    if af.Thumbnail and af.Thumbnail.Image then
      ...
      { ar, ac("UICorner", { CornerRadius = UDim.new(0, 0) }) }
      )
    end
    ac(
    "Frame",
...
function a.t()
  ...
  function aa.New(ae, af, ag, ah, ai)
    ...
    local am = ac(
    "TextButton",
    { Size = UDim2.new(1, 0, 0, 42), Parent = ag, BackgroundTransparency = 1, Text = "" },
    {
      ac(
      "Frame",
      { Size = UDim2.new(1, 0, 1, 0), BackgroundTransparency = 1 },
      {
        ...
        {
          ac("UIPadding", { PaddingLeft = UDim.new(0, 12), PaddingRight = UDim.new(0, 12) }),
          ac(
          "UIListLayout",
          {
            FillDirection = "Horizontal",
...
function a.u()
  ...
  function aa.New(af, ag, ah, ai)
    ...
    local ak = ac.NewRoundFrame(
    ai / 2,
    "Squircle",
    { Size = UDim2.new(1, 0, 0, 0), ImageTransparency = 0.85, ThemeTag = { ImageColor3 = "Text" }, Parent = aj }
    )
    local al = ad(
    "Frame",
    {
...
function a.v()
  ...
  local function Color3ToHSB(ae)
    ...
    local an = ai
    return { h = math.floor(al + 0.5), s = am, b = an }
  end
  ...
  function aa.New(ae, af, ag)
    ...
    },
    {
      ...
      ac(
      "UIListLayout",
      { FillDirection = "Horizontal", VerticalAlignment = "Center", Padding = UDim.new(
        0,
        ah.Padding / 1.5
        ) }
      ),
    ...
    function ah.SetColor(am, an)
      ...
      if typeof(an) == "table" then
        ...
        ad(aj, 0.06, { TextColor3 = GetTextColorForHSB(ao) }):Play()
        ...
        ad(aj, 0.06, { TextColor3 = GetTextColorForHSB(an) }):Play()
        if ai then
          ad(ai.ImageLabel, 0.06, { ImageColor3 = GetTextColorForHSB(an) }):Play()
        end
...
function a.w()
  ...
  ac = {
    ...
    Parser = {
      Colorpicker = {
        Save = function(ad)
          return { __type = ad.__type, value = ad.Default:ToHex(), transparency = ad.Transparency or nil }
        end,
        Load = function(ad, ae)
      ...
      Dropdown = {
        Save = function(ad)
          return { __type = ad.__type, value = ad.Value }
        end,
        Load = function(ad, ae)
      ...
      Slider = {
        Save = function(ad)
          return { __type = ad.__type, value = ad.Value.Default }
        end,
        Load = function(ad, ae)
          if ad and ad.Set then
  ...
  function ac.CreateConfig(ad, ae)
    local af = { Path = ac.Path .. ae .. ".json", Elements = {}, CustomData = {}, Version = 1.1 }
    if not ae then
    ...
    function af.Save(ag)
      ...
      local ah = { __version = af.Version, __elements = {}, __custom = af.CustomData }
    ...
    function af.Load(ag)
      ...
      if not ai.__version then
        local aj = { __version = af.Version, __elements = ai, __custom = {} }
        ai = aj
      end
      if ab.PendingFlags then
    ...
    function af.GetData(ag)
      return { elements = af.Elements, custom = af.CustomData }
    end
    af:SetAsCurrent()
    ac.Configs[ae] = af
    return af
...
function a.x()
  ...
  function aa.New(ae)
    ...
    local ai = ac(
    "Frame",
    { Size = UDim2.new(0, 36, 0, 36), BackgroundTransparency = 1, Name = "Drag" },
    {
      ac(
      "ImageLabel",
      {
    ...
    },
    {
      ...
      ac(
      "UIStroke",
      { Thickness = 1, ApplyStrokeMode = "Border", Color = Color3.new(1, 1, 1), Transparency = 0 },
      { ac(
        "UIGradient",
      ...
      ac(
      "UIListLayout",
      { Padding = UDim.new(0, 4), FillDirection = "Horizontal", VerticalAlignment = "Center" }
      ),
      ac(
      "TextButton",
      {
      ...
      {
        ac("UICorner", { CornerRadius = UDim.new(1, -4) }),
        ag,
        ac(
        "UIListLayout",
        {
      ...
      ac("UIPadding", { PaddingLeft = UDim.new(0, 4), PaddingRight = UDim.new(0, 4) }),
    }
    )
    af.Button = al
...
function a.y()
  ...
  function aa.New(ae, af)
    local ag = { Container = nil, ToolTipSize = 16 }
    local ah = ac(
    "TextLabel",
    {
      AutomaticSize = "XY",
    ...
    {
      ac("UISizeConstraint", { MaxSize = Vector2.new(400, math.huge) }),
      ac(
      "Frame",
      { AutomaticSize = "XY", BackgroundTransparency = 1, LayoutOrder = 99, Visible = false },
      {
        ac(
        "ImageLabel",
        {
      ...
      },
      {
        ac(
        "Frame",
        { ThemeTag = { BackgroundColor3 = "Text" }, AutomaticSize = "XY", BackgroundTransparency = 1 },
        {
          ac("UICorner", { CornerRadius = UDim.new(0, 16) }),
          ac(
          "UIListLayout",
          {
  ...
  return function(ae)
    ...
    local function CreateText(am, an)
      ...
      "TextLabel",
      {
        ...
        TextXAlignment = "Left",
        ThemeTag = { TextColor3 = not af.Color and ("Element" .. an) or nil },
        ...
        FontFace = Font.new(
        aa.Font,
        an == "Desc" and Enum.FontWeight.Medium or Enum.FontWeight.SemiBold
        ),
      }
      )
    end
    ...
    af.UIElements.Container = ab(
    "Frame",
    { Size = UDim2.new(1, 0, 1, 0), AutomaticSize = "Y", BackgroundTransparency = 1 },
    {
      ab(
      "UIListLayout",
      {
      ...
      },
      {
        ...
        "UIListLayout",
        {
          Padding = UDim.new(0, af.UIPadding),
          FillDirection = "Horizontal",
          VerticalAlignment = ae.Window.NewElements
          and (af.Justify == "Between" and "Top" or "Center")
          or "Center",
        ...
        },
        {
          ...
          "UIPadding",
          {
            ...
            0,
            ae.Window.NewElements and af.UIPadding / 2 or 0
            ),
          }
          ),
          ab(
    ...
    "Squircle",
    {
      ...
      Parent = ae.Parent,
      ThemeTag = { ImageColor3 = not af.Color and "ElementBackground" or nil },
      ImageColor3 = af.Color
      and (typeof(af.Color) == "string" and Color3.fromHex(aa.Colors[af.Color]) or typeof(
      af.Color
      ) == "Color3" and af.Color)
      or nil,
    },
    ...
    if af.Hover then
      aa.AddSignal(aB.MouseEnter, function()
        if ai then
          ad(aB, 0.12, { ImageTransparency = af.Color and 0.15 or 0.9 }):Play()
          ad(az, 0.12, { ImageTransparency = 0.9 }):Play()
          ad(ax, 0.12, { ImageTransparency = 0.8 }):Play()
          aa.AddSignal(aB.MouseMoved, function(aD, aE)
            az.HoverGradient.Offset =
            Vector2.new(((aD - aB.AbsolutePosition.X) / aB.AbsoluteSize.X) - 0.5, 0)
            ax.HoverGradient.Offset =
            Vector2.new(((aD - aB.AbsolutePosition.X) / aB.AbsoluteSize.X) - 0.5, 0)
          end)
        end
      end)
      aa.AddSignal(aB.InputEnded, function()
        if ai then
          ad(aB, 0.12, { ImageTransparency = af.Color and 0.05 or 0.93 }):Play()
          ad(az, 0.12, { ImageTransparency = 1 }):Play()
          ad(ax, 0.12, { ImageTransparency = 1 }):Play()
        end
      end)
    end
    ...
    function af.Colorize(aD, aE, b)
      if af.Color then
        aE[b] = typeof(af.Color) == "string" and GetTextColorForHSB(Color3.fromHex(aa.Colors[af.Color]))
        or typeof(af.Color) == "Color3" and GetTextColorForHSB(af.Color)
        or nil
      end
    end
    ...
    function af.SetThumbnail(aD, aE, b)
      ...
      if ak then
        if aE then
          ak:Destroy()
          ak =
          aa.Image(aE, af.Title, af.UICorner - 3, ae.Window.Folder, "Thumbnail", false, af.IconThemed)
          ak.Size = UDim2.new(1, 0, 0, ah)
    ...
    function af.Highlight(aD)
      ...
      ad(aE, 0.75, { Offset = Vector2.new(1, 0) }):Play()
      ad(b, 0.75, { Offset = Vector2.new(1, 0) }):Play()
      task.spawn(function()
        task.wait(0.75)
...
function a.A()
  ...
  function ac.New(ae, af)
    ...
    local ag =
    { __type = "Paragraph", Title = af.Title or "Paragraph", Desc = af.Desc or nil, Locked = af.Locked
      or false }
...
function a.C()
  ...
  function aa.New(ae, af, ag, ah, ai)
    ...
    },
    {
      ...
      ak,
      "SquircleOutline",
      { Size = UDim2.new(1, 0, 1, 0), Name = "Stroke", ImageColor3 = Color3.new(1, 1, 1), ImageTransparency = 1 },
      {
        ac(
        "UIGradient",
        {
    ...
    function aj.Set(an, ao, ap)
      if ao then
        ...
        ad(am.Layer, 0.1, { ImageTransparency = 0 }):Play()
        if al then
          ad(al, 0.1, { ImageTransparency = 0 }):Play()
        end
       else
        ad(
        am.Frame,
        ...
        ad(am.Layer, 0.1, { ImageTransparency = 1 }):Play()
        if al then
          ad(al, 0.1, { ImageTransparency = 1 }):Play()
        end
      end
      if ap ~= false then
        ap = true
...
function a.D()
  ...
  function aa.New(ae, af, ag, ah, ai)
    ...
    af = af or "check"
    local ak = 9
    local al = ab.Image(af, af, 0, (ai and ai.Window.Folder or "Temp"), "Checkbox", true, false, "CheckboxIcon")
    ...
    ak,
    "Squircle",
    { ImageTransparency = 0.85, ThemeTag = { ImageColor3 = "Text" }, Parent = ag, Size = UDim2.new(
      0,
      26,
      0,
      26
    ...
    function aj.Set(an, ao)
      if ao then
        ad(am.Layer, 0.06, { ImageTransparency = 0 }):Play()
        ad(al.ImageLabel, 0.06, { ImageTransparency = 0 }):Play()
       else
        ad(am.Layer, 0.05, { ImageTransparency = 1 }):Play()
        ad(al.ImageLabel, 0.06, { ImageTransparency = 1 }):Play()
      end
      task.spawn(function()
        if ah then
          ab.SafeCallback(ah, ao)
...
function a.F()
  ...
  function ae.New(ag, ah)
    ...
    ai.UIElements.SliderIcon = aa.NewRoundFrame(
    99,
    "Squircle",
    {
      ImageTransparency = 0.95,
    ...
    },
    {
      ...
      },
      {
        ...
        "Squircle",
        {
          Size = UDim2.new(
          0,
          ah.Window.NewElements and (ai.ThumbSize * 1.75) or (ai.ThumbSize + 2),
          0,
          ai.ThumbSize + 2
          ),
          Position = UDim2.new(1, 0, 0.5, 0),
    ...
    ai.UIElements.SliderContainer = ac(
    "Frame",
    {
    ...
    aa.AddSignal(ai.UIElements.SliderContainer.InputBegan, function(as)
      ...
      if
        ...
        0.24,
        {
          Size = UDim2.new(
          0,
          (ah.Window.NewElements and (ai.ThumbSize * 1.75) or ai.ThumbSize) + 8,
          0,
          ai.ThumbSize + 8
          ),
        },
...
function a.G()
  ...
  local ad = ac.New
  local ae = ac.Tween
  local af = { UICorner = 6, UIPadding = 8 }
  ...
  function af.New(ah, ai)
    ...
    ad("UIScale", { Parent = aj.UIElements.Keybind, Scale = 0.85 })
...
function a.I()
  ...
  function ae.New(af, ag)
    ...
    local ai = ac(
    "Frame",
    { Parent = ag.Parent, Size = UDim2.new(1, -7, 0, 7), BackgroundTransparency = 1 },
    { ah }
    )
...
function a.J()
  ...
  function aa.New(al, am, an, ao, ap)
    ...
    am.UIElements.UIListLayout = aj(
    "UIListLayout",
    { Padding = UDim.new(0, an.MenuPadding / 1.5), FillDirection = "Vertical", HorizontalAlignment = "Center" }
    )
    am.UIElements.Menu = ai.NewRoundFrame(
    an.MenuCorner,
    "Squircle",
    {
      ThemeTag = { ImageColor3 = "Background" },
    ...
    },
    {
      ...
      aj("UIListLayout", { FillDirection = "Vertical", Padding = UDim.new(0, an.MenuPadding) }),
      aj(
      "Frame",
      {
        BackgroundTransparency = 1,
      ...
      {
        aj("UICorner", { CornerRadius = UDim.new(0, an.MenuCorner - an.MenuPadding) }),
        aj(
        "ScrollingFrame",
        {
          Size = UDim2.new(1, 0, 1, 0),
    ...
    {
      am.UIElements.Menu,
      aj("UISizeConstraint", { MinSize = Vector2.new(170, 0), MaxSize = Vector2.new(300, 400) }),
    }
    )
    ...
    function aq.Refresh(as, at)
      ...
      for aw, ax in next, at do
        if ax.Type ~= "Divider" then
          ...
          ay.UIElements.TabItem = ai.NewRoundFrame(
          ...
          },
          {
            ...
            { Size = UDim2.new(1, 0, 1, 0), BackgroundTransparency = 1 },
            {
              ...
              },
              {
                ...
                aj(
                "UIListLayout",
                { Padding = UDim.new(0, an.TabPadding / 3), FillDirection = "Vertical" }
                ),
              }
              ),
            }
            ...
            ai.AddSignal(ay.UIElements.TabItem.MouseButton1Click, function()
              ...
              if am.Multi then
                if not ay.Selected then
                  ...
                  ak(ay.UIElements.TabItem.Frame.Title.TextLabel, 0.1, { TextTransparency = 0.4 }):Play()
                  if ay.UIElements.TabIcon then
                ...
                for aA, aB in next, am.Tabs do
                  ...
                  ak(aB.UIElements.TabItem.Frame.Title.TextLabel, 0.1, { TextTransparency = 0.4 }):Play()
          ...
          a.load("I"):New({ Parent = am.UIElements.Menu.Frame.ScrollingFrame })
        end
      end
    ...
    function aq.Open(as)
      if ao then
        ...
        am.UIElements.Menu,
        0.1,
        { Size = UDim2.new(1, 0, 1, 0), ImageTransparency = 0.05 },
    ...
    function aq.Close(as)
      ...
      am.UIElements.Menu,
      0.25,
      { Size = UDim2.new(1, 0, 0, 0), ImageTransparency = 1 },
      Enum.EasingStyle.Quart,
      Enum.EasingDirection.Out
      ):Play()
      task.spawn(function()
...
function a.M()
  ...
  function ac.New(ak, al, am, an, ao)
    ...
    },
    {
      ...
      ap.Radius,
      "SquircleOutline",
      { Size = UDim2.new(1, 0, 1, 0), ImageColor3 = Color3.fromHex("#ffffff"), ImageTransparency = 0.955 }
      ),
      ag(
      "Frame",
      { BackgroundTransparency = 1, Size = UDim2.new(1, 0, 0, 0), AutomaticSize = "Y" },
      {
        ae.NewRoundFrame(
        ap.Radius,
        "Squircle-TL-TR",
        ...
        },
        {
          ...
          ag(
          "UIPadding",
          { PaddingLeft = UDim.new(0, ap.Padding + 3), PaddingRight = UDim.new(
            0,
            ap.Padding + 3
            ) }
          ),
        ...
        ar,
        ag("UIListLayout", { Padding = UDim.new(0, 0), FillDirection = "Vertical" }),
      }
      ),
      as,
    }
...
function a.N()
  ...
  function ai.New(aj, ak)
    local al = { __type = "Code", Title = ak.Title, Code = ak.Code, OnCopy = ak.OnCopy }
...
function a.O()
  ...
  local aq = { UICorner = 8, UIPadding = 8 }
  function aq.Colorpicker(ar, as, at, au)
    ...
    {
      ae("UIStroke", { Thickness = 2, Transparency = 0.1, ThemeTag = { Color = "Text" } }),
      ae("UICorner", { CornerRadius = UDim.new(1, 0) }),
    }
    )
    av.UIElements.SatVibMap = ae(
    "ImageLabel",
    {
    ...
    local aC = ae(
    "Frame",
    { BackgroundColor3 = av.Default, Size = UDim2.fromScale(1, 1), BackgroundTransparency = av.Transparency },
    { ae("UICorner", { CornerRadius = UDim.new(0, 8) }) }
    )
    ae(
    "ImageLabel",
    ...
    local aD = ae(
    "Frame",
    { BackgroundColor3 = av.Default, Size = UDim2.fromScale(1, 1), BackgroundTransparency = 0, ZIndex = 9 },
    { ae("UICorner", { CornerRadius = UDim.new(0, 8) }) }
    )
    ae(
    "ImageLabel",
    ...
    local b = ae("UIGradient", { Color = ColorSequence.new(aE), Rotation = 90 })
    local e = ae(
    "Frame",
    { Size = UDim2.new(1, 0, 1, 0), Position = UDim2.new(0, 0, 0, 0), BackgroundTransparency = 1 }
    )
    local g = ae(
    "Frame",
    {
    ...
    { ae("UICorner", { CornerRadius = UDim.new(1, 0) }), b, e }
    )
    function CreateNewInput(i, j)
      ...
      ae("UIScale", { Parent = l, Scale = 0.85 })
      l.Frame.Frame.TextBox.Text = j
      l.Size = UDim2.new(0, 150, 0, 42)
      return l
    end
    local function ToRGB(i)
      return { R = math.floor(i.R * 255), G = math.floor(i.G * 255), B = math.floor(i.B * 255) }
    end
    ...
    },
    {
      ae(
      "UIListLayout",
      { Padding = UDim.new(0, 6), FillDirection = "Horizontal", HorizontalAlignment = "Right" }
      ),
    }
    )
    local u = {
    ...
    if av.Transparency then
      local G = ae(
      "Frame",
      { Size = UDim2.new(1, 0, 1, 0), Position = UDim2.fromOffset(0, 0), BackgroundTransparency = 1 }
      )
      C = ae(
      "ImageLabel",
      {
      ...
      { Size = UDim2.fromScale(1, 1) },
      {
        ...
        ae("UICorner", { CornerRadius = UDim.new(0, 6) }),
      }
      )
      B = ae(
      "Frame",
  ...
  function aq.New(ar, as)
    ...
    at.UIElements.Colorpicker = ac.NewRoundFrame(
    aq.UICorner,
    "Squircle",
    {
      ImageTransparency = 0,
...
function a.P()
  ...
  function ai.New(aj, ak)
    ...
    local an = ae(
    "Frame",
    { Size = UDim2.new(0, al.IconSize, 0, al.IconSize), BackgroundTransparency = 1, Visible = false },
    {
      ae(
      "ImageLabel",
      {
    ...
    },
    {
      ...
      },
      {
        ...
        ae(
        "UIListLayout",
        { FillDirection = "Vertical", Padding = UDim.new(0, ak.Tab.Gap), VerticalAlignment = "Top" }
        ),
      }
      ),
    }
...
function a.Q()
  ...
  function ag.New(ai, aj)
    local ak = ae(
    "Frame",
    { Parent = aj.Parent, Size = UDim2.new(1, -7, 0, 7 * (aj.Columns or 1)), BackgroundTransparency = 1 }
    )
...
function a.R()
  ...
  function ag.New(ai, aj)
    ...
    if am then
      ...
      { Parent = al, AspectRatio = am, AspectType = "ScaleWithParentSize", DominantAxis = "Width" }
      )
    end
...
function a.T()
  ...
  function al.New(am, an)
    ...
    ao.Index = ap
    ao.UIElements.Main = ae.NewRoundFrame(
    ao.UICorner,
    "Squircle",
    {
      BackgroundTransparency = 1,
    ...
    ao.UIElements.ContainerFrame = ag(
    "ScrollingFrame",
    {
    ...
    },
    {
      ...
      ag(
      "UIListLayout",
      { SortOrder = "LayoutOrder", Padding = UDim.new(0, ao.Gap), HorizontalAlignment = "Center" }
      ),
    }
    )
    ao.UIElements.ContainerFrameCanvas = ag(
    "Frame",
    {
      Size = UDim2.new(1, 0, 1, 0),
      BackgroundTransparency = 1,
...
function a.U()
  ...
  function ac.New(ak, al, am, an, ao)
    ...
    local ar = ag(
    "Frame",
    { Size = UDim2.new(0, ap.IconSize, 0, ap.IconSize), BackgroundTransparency = 1, Visible = false },
    {
      ag(
      "ImageLabel",
      {
    ...
    local as = ag(
    "Frame",
    { Size = UDim2.new(1, 0, 0, ap.HeaderSize), BackgroundTransparency = 1, Parent = al, ClipsDescendants = true },
    {
      ag(
      "TextButton",
      { Size = UDim2.new(1, 0, 0, ap.HeaderSize), BackgroundTransparency = 1, Text = "" },
      {
        aq,
        ag(
        "TextLabel",
        ...
        ag(
        "UIListLayout",
        { FillDirection = "Horizontal", VerticalAlignment = "Center", Padding = UDim.new(0, 10) }
        ),
        ar,
        ag("UIPadding", { PaddingLeft = UDim.new(0, 11), PaddingRight = UDim.new(0, 11) }),
      }
      ),
      ag(
      "Frame",
      ...
      },
      {
        ag(
        "UIListLayout",
        { FillDirection = "Vertical", Padding = UDim.new(0, ao.Gap), VerticalAlignment = "Bottom" }
        ),
      }
      ),
    }
...
function a.W()
  game:GetService("UserInputService")
  local ac = { Margin = 8, Padding = 9 }
  local ae = a.load("b")
  local ag = ae.New
  local ai = ae.Tween
  function ac.new(aj, ak, al)
    local am = { IconSize = 18, Padding = 14, Radius = 22, Width = 400, MaxHeight = 380, Icons = a.load("V") }
    local an = ag(
    "TextBox",
    {
      Text = "",
      PlaceholderText = "Search...",
      ThemeTag = { PlaceholderColor3 = "Placeholder", TextColor3 = "Text" },
    ...
    local aq = ae.NewRoundFrame(
    am.Radius,
    "Squircle",
    { Size = UDim2.new(1, 0, 1, 0), ThemeTag = { ImageColor3 = "Background" }, ImageTransparency = 0 },
    {
      ae.NewRoundFrame(
      am.Radius,
      "Squircle",
      ...
      },
      {
        ...
        ag(
        "Frame",
        { BackgroundTransparency = 1, AutomaticSize = "Y", Size = UDim2.new(1, 0, 0, 0), Name = "Results" },
        {
          ag(
          "Frame",
          {
          ...
          ap,
          ag("UISizeConstraint", { MaxSize = Vector2.new(am.Width, am.MaxHeight) }),
        }
        ),
        ag("UIListLayout", { Padding = UDim.new(0, 0), FillDirection = "Vertical" }),
      }
    ...
    {
      ag("UIScale", { Scale = 0.9 }),
      aq,
      ae.NewRoundFrame(
      am.Radius,
      "SquircleOutline2",
      { Size = UDim2.new(1, 0, 1, 0), ThemeTag = { ImageColor3 = "Outline" }, ImageTransparency = 1 },
      {
        ag(
        "UIGradient",
        {
    ...
    local function CreateSearchTab(as, at, au, av, aw, ax)
      local ay = ag(
      "TextButton",
      { Size = UDim2.new(1, 0, 0, 0), AutomaticSize = "Y", BackgroundTransparency = 1, Parent = av or nil },
      {
        ae.NewRoundFrame(
        am.Radius - 11,
        "Squircle",
        ...
        },
        {
          ...
          },
          {
            ...
            ag(
            "Frame",
            { Size = UDim2.new(1, -am.IconSize - am.Padding, 0, 0), BackgroundTransparency = 1 },
            {
              ag(
              "TextLabel",
              {
              ...
              ag(
              "UIListLayout",
              { Padding = UDim.new(0, 6), FillDirection = "Vertical" }
              ),
            }
            ),
            ag(
            "UIListLayout",
            { Padding = UDim.new(0, am.Padding), FillDirection = "Horizontal" }
            ),
          }
          ),
        },
        ...
        ag(
        "UIListLayout",
        { Padding = UDim.new(0, 0), FillDirection = "Vertical", HorizontalAlignment = "Right" }
        ),
      }
      )
      ...
      ae.AddSignal(ay.Main.MouseEnter, function()
        ...
        ai(ay.Main.Outline, 0.04, { ImageTransparency = 0.7 }):Play()
      end)
      ...
      for au, av in next, aj.Tabs do
        ...
        for ay, az in next, av.Elements do
          if az.__type ~= "Section" then
            ...
            if aA or aB then
              ax[ay] =
              { Title = az.Title, Desc = az.Desc, Original = az, __type = az.__type, Index = ay }
            end
          end
        end
        if aw or next(ax) ~= nil then
          at[au] = { Tab = av, Title = av.Title, Icon = av.Icon, Elements = ax }
        end
      end
      return at
    end
        ...
        for ax, ay in next, au do
          ...
          if ay.Elements and next(ay.Elements) ~= nil then
            for aB, aC in next, ay.Elements do
              ...
              aC.Desc,
              aD,
              aA:FindFirstChild("ParentContainer") and aA.ParentContainer.Frame or nil,
              false,
              function()
                am:Close()
                aj:SelectTab(ax)
...
function a.X()
  ...
  return function(aq)
    ...
    ar.ElementConfig =
    { UIPadding = (ar.NewElements and 10 or 13), UICorner = ar.ElementsRadius
      or (ar.NewElements and 23 or 12) }
    ...
    local at = aj("UICorner", { CornerRadius = UDim.new(0, ar.UICorner) })
    if ar.Folder then
      ar.ConfigManager = ap:Init(ar)
    end
    if ar.Acrylic then
      local au, av = ag.AcrylicPaint({ UseAcrylic = ar.Acrylic })
      ar.AcrylicPaint = au
    end
    local au = aj(
    "Frame",
    ...
    local av = ai.NewRoundFrame(
    ar.UICorner,
    "Squircle",
    { Size = UDim2.new(1, 0, 1, 0), ImageTransparency = 1, ImageColor3 = Color3.new(0, 0, 0), ZIndex = 98, Active = false },
    {
      aj(
      "ImageLabel",
      {
    ...
    },
    {
      aj(
      "Frame",
      { BackgroundTransparency = 1, AutomaticSize = "Y", Size = UDim2.new(1, 0, 0, 0), Name = "Frame" },
      {
        aj(
        "UIPadding",
        { PaddingTop = UDim.new(0, ar.UIPadding / 2), PaddingBottom = UDim.new(
          0,
          ar.UIPadding / 2
          ) }
        ),
        aj("UIListLayout", { SortOrder = "LayoutOrder", Padding = UDim.new(0, ar.Gap) }),
      }
      ),
      aj(
      "UIPadding",
      { PaddingLeft = UDim.new(0, ar.UIPadding / 2), PaddingRight = UDim.new(0, ar.UIPadding / 2) }
      ),
    }
    )
    ar.UIElements.SideBarContainer = aj(
    "Frame",
    {
    ...
    if ar.User then
      ...
      },
      {
        ...
        },
        {
          ...
          aj(
          "Frame",
          { AutomaticSize = "XY", BackgroundTransparency = 1 },
          {
            aj(
            "TextLabel",
            {
              Text = ar.User.Anonymous and "Anonymous"
            ...
            aj("UIListLayout", { Padding = UDim.new(0, 4), HorizontalAlignment = "Left" }),
          }
          ),
          aj(
          "UIListLayout",
          ...
          aj(
          "UIPadding",
          { PaddingLeft = UDim.new(0, ar.UIPadding / 2), PaddingRight = UDim.new(
            0,
            ar.UIPadding / 2
            ) }
          ),
      ...
      function ar.User.SetAnonymous(az, aA)
        ...
        ay.UserIcon.Frame.DisplayName.Text = aA and "Anonymous"
        or game:GetService("Players").LocalPlayer.DisplayName
        ay.UserIcon.Frame.UserName.Text = aA and "anonymous" or game:GetService("Players").LocalPlayer.Name
      end
    ...
    if typeof(ar.Background) == "string" and aD then
      ...
      if string.find(aD, "http") then
        ...
        if not isfile(b) then
          local e, g = pcall(function()
            local e = ai.Request({ Url = aD, Method = "GET", Headers = {
      ...
      aC = aj(
      "VideoFrame",
      { BackgroundTransparency = 1, Size = UDim2.new(1, 0, 1, 0), Video = aD, Looped = true, Volume = 0 },
      { aj("UICorner", { CornerRadius = UDim.new(0, ar.UICorner) }) }
      )
      aC:Play()
     elseif aE then
      ...
      if not isfile(b) then
        local e, g = pcall(function()
          local e =
          ai.Request({ Url = aE, Method = "GET", Headers = { ["User-Agent"] = "Roblox/Exploit" } })
          writefile(b, e.Body)
        end)
        if not e then
    ...
    },
    {
      ...
      aj(
      "UIStroke",
      { Thickness = 1.5, Color = Color3.fromRGB(255, 255, 255) },
      {
        aj(
        "UIGradient",
        {
          Color = ColorSequence.new({
            ColorSequenceKeypoint.new(0.00, Color3.fromRGB(191, 0, 255)),
            ColorSequenceKeypoint.new(0.50, Color3.fromRGB(0, 221, 255)),
            ColorSequenceKeypoint.new(1.00, Color3.fromRGB(10, 255, 0)),
          }),
          Rotation = 0,
        }
        ),
      ...
      aj(
      "Frame",
      { Size = UDim2.new(1, 0, 1, 0), BackgroundTransparency = 1, Name = "Main", Visible = false, ZIndex = 97 },
      {
        aj("UICorner", { CornerRadius = UDim.new(0, ar.UICorner) }),
        ar.UIElements.SideBarContainer,
        ...
        },
        {
          ...
          },
          {
            ...
            aj("UIPadding", { PaddingLeft = UDim.new(0, 4) }),
          }
          ),
          aj(
          "ScrollingFrame",
    ...
    ai.AddSignal(game:GetService("RunService").RenderStepped, function()
      ...
      ar.UIElements.Main.UIStroke.UIGradient.Rotation = (ar.UIElements.Main.UIStroke.UIGradient.Rotation + 1)
      % 360
    end)
    ai.AddSignal(ar.UIElements.Main.Main.Topbar.Left:GetPropertyChangedSignal("AbsoluteSize"), function()
      ...
      if g then
        i = i
        + (ar.IconSize / aq.WindUI.UIScale)
        + (ar.UIPadding / aq.WindUI.UIScale)
        + (4 / aq.WindUI.UIScale)
      end
      ar.UIElements.Main.Main.Topbar.Center.Position =
      UDim2.new(0, i + (ar.UIPadding / aq.WindUI.UIScale), 0.5, 0)
      ar.UIElements.Main.Main.Topbar.Center.Size =
      UDim2.new(1, -i - j - ((ar.UIPadding * 2) / aq.WindUI.UIScale), 1, 0)
    end)
    function ar.CreateTopbarButton(i, j, l, m, p, r)
      local u = ai.Image(l, l, 0, ar.Folder, "WindowTopbarIcon", true, r, "WindowTopbarButtonIcon")
      ...
      ar.TopBarButtons[100 - p] = { Name = j, Object = v }
      ai.AddSignal(v.MouseButton1Click, function()
        m()
      end)
      ai.AddSignal(v.MouseEnter, function()
        ak(v, 0.15, { ImageTransparency = 0.93 }):Play()
        ak(v.Outline, 0.15, { ImageTransparency = 0.75 }):Play()
      end)
      ai.AddSignal(v.MouseLeave, function()
        ak(v, 0.1, { ImageTransparency = 1 }):Play()
        ak(v.Outline, 0.1, { ImageTransparency = 1 }):Play()
      end)
      return v
    end
    local i = ai.Drag(ar.UIElements.Main, { ar.UIElements.Main.Main.Topbar, b.Frame }, function(i, j)
      if not ar.Closed then
        if i and j == b.Frame then
          ak(b, 0.1, { ImageTransparency = 0.35 }):Play()
         else
          ak(b, 0.2, { ImageTransparency = 0.8 }):Play()
        end
    ...
    if not aB and ar.Background and typeof(ar.Background) == "table" then
      ...
      ar.UIElements.BackgroundGradient = ai.NewRoundFrame(
      ar.UICorner,
      "Squircle",
      {
        Size = UDim2.new(1, 0, 1, 0),
    ...
    task.spawn(function()
      if ar.Icon then
        g = ai.Image(ar.Icon, ar.Title, 0, ar.Folder, "Window", true, ar.IconThemed, "WindowTopbarIcon")
    ...
    function ar.Open(m)
      task.spawn(function()
        ...
        if ar.UIElements.BackgroundGradient then
          ak(
          ar.UIElements.BackgroundGradient,
          0.2,
          { ImageTransparency = 0 },
          Enum.EasingStyle.Quint,
          Enum.EasingDirection.Out
    ...
    function ar.Close(m)
      ...
      if aC then
        if aC:IsA("VideoFrame") then
          ...
          ak(aC, 0.3, { ImageTransparency = 1 }, Enum.EasingStyle.Quint, Enum.EasingDirection.Out):Play()
        end
      end
    ...
    function ar.SetUIScale(m, p)
      aq.WindUI.UIScale = p
      ak(aq.WindUI.ScreenGui.UIScale, 0.2, { Scale = p }, Enum.EasingStyle.Quint, Enum.EasingDirection.Out):Play()
      return ar
    end
  ...
  function ar.Divider(u)
    ...
    local A = aj(
    "Frame",
    { Parent = ar.UIElements.SideBar.Frame, Size = UDim2.new(1, -7, 0, 5), BackgroundTransparency = 1 },
    { v }
    )
    return A
  end
  ...
  function ar.Dialog(v, A)
    ...
    local F = aj(
    "Frame",
    { Size = UDim2.new(1, 0, 0, 0), AutomaticSize = "Y", BackgroundTransparency = 1, Parent = C.UIElements.Main },
    {
      aj(
      "UIListLayout",
      { FillDirection = "Horizontal", Padding = UDim.new(0, C.UIPadding), VerticalAlignment = "Center" }
      ),
      aj(
      "UIPadding",
      {
    ...
    local G
    if A.Icon then
      G = ai.Image(A.Icon, B.Title .. ":" .. A.Icon, 0, ar, "Dialog", true, A.IconThemed)
      G.Size = UDim2.new(0, 22, 0, 22)
      G.Parent = F
    end
    C.UIElements.UIListLayout = aj(
    "UIListLayout",
    {
      Padding = UDim.new(0, 12),
      FillDirection = "Vertical",
    ...
    aj(
    "UISizeConstraint",
    { MinSize = Vector2.new(180, 20), MaxSize = Vector2.new(400, math.huge), Parent = C.UIElements.Main }
    )
    C.UIElements.Title = aj(
    "TextLabel",
    {
      Text = B.Title,
      TextSize = 20,
  ...
  ai.AddSignal(ac.InputChanged, function(v)
    if
      ...
      if isResizing and ar.CanResize then
        ...
        ak(ar.UIElements.Main, 0, { Size = B }):Play()
        ar.Size = B
      end
    end
  end)
...
ac.ScreenGui = al(
"ScreenGui",
{ Name = "WindUI", Parent = aq, IgnoreGuiInset = true, ScreenInsets = "None" },
{
  al("UIScale", { Scale = ac.Scale }),
...
ac.NotificationGui = al("ScreenGui", { Name = "WindUI/Notifications", Parent = aq, IgnoreGuiInset = true })
ac.DropdownGui = al("ScreenGui", { Name = "WindUI/Dropdowns", Parent = aq, IgnoreGuiInset = true })
ap(ac.ScreenGui)
...
function ac.Gradient(as, at, au)
  ...
  local az = { Color = ColorSequence.new(av), Transparency = NumberSequence.new(aw) }
  if au then
  ...
  if at.KeySystem then
    ...
    if not at.KeySystem.API then
      if at.KeySystem.SaveKey and isfile(az) then
        ...
        local aB = (type(at.KeySystem.Key) == "table") and table.find(at.KeySystem.Key, aA)
